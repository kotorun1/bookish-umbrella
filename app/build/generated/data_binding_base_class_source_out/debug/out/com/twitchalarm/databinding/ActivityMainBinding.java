...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull AppBarLayout appBarLayout, @NonNull MaterialButton btnAdd,
      @NonNull TextInputEditText etNickname, @NonNull ProgressBar progressAdd,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, appBarLayout, btnAdd, etNickname,
          progressAdd, recyclerView, toolbar, tvEmpty);
    }
